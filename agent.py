...
class BidAnalyzerAgent:
    ...
    def _preprocess_rfp(self, state: AgentState) -> Dict[str, Any]:
        ...
        print("--- Agent: Summarizing RFP with Ollama ---")
...
RFP Text (first 8000 chars): {rfp_text[:8000]}"""
        ...
        summary_str = self.ollama_client.generate(prompt, json_mode=True)
        try:
            summary = json.loads(summary_str)
        except json.JSONDecodeError:
            print("Warning: Ollama did not return valid JSON. Using basic summary.")
